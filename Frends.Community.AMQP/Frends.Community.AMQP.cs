...
namespace Frends.Community.AMQP
{
    public class ClassName
    {
        ...
        /// <returns></returns>
        public static async Task<dynamic> AmqpReceiver(AmqpConnection connection)
        {
            ...
            var ret = new AmqpMessageReceive
            {
        ...
        /// <returns></returns>
        public static async Task<sendMessageResult> AmqpSender(AmqpConnection connection, AmqpMessageSend message)
        {
            var conn = await CreateConnection(connection);
            var session = new Session(conn);
        ...
        private static Message CreateMessage(AmqpMessageSend amqpMessage)
        {
        ...
        private static X509Certificate2 FindCertificateByFile(AmqpConnection connection)
        {
        ...
        private static async Task<Connection> CreateConnection(AmqpConnection connection)
        {
